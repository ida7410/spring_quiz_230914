...
public class Lesson05Controller {
	...
	public String quiz02(Model model) {
		...
		model.addAttribute("ranking", musicRanking);
		model.addAttribute("title1", "HOT5");
	...
	public String quiz03(Model model) {
		...
		model.addAttribute("title1", "후보자 득표율");
		...
		model.addAttribute("title2", "카드 명세서");
	...
	public String quiz04(Model model) {
		...
		model.addAttribute("title", "회원 정보 리스트");
